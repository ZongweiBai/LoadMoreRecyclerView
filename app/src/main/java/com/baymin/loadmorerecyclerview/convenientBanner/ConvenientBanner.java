...
import com.baymin.loadmorerecyclerview.R;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private TextView loPageTurningTitle;
    ...
    private void init(Context context) {
        ...
        loPageTurningTitle = (TextView) hView.findViewById(R.id.loPageTurningTitle);
        initViewPagerScroll();
    }
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        // 设置初始的title显示
        if (mDatas != null && !mDatas.isEmpty() && loPageTurningTitle != null) {

        }

        pageChangeListener = new CBPageChangeListener(mPointViews, page_indicatorId, loPageTurningTitle, mDatas);
            ...
            viewPager
                    .setPageTransformer(
                            ...
                            (PageTransformer) Class.forName(
                                    "com.monosky.zhihudaily.widget.convenientBanner.transforms."
